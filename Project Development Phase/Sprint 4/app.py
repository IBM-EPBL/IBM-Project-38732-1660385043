...
st.sidebar.info("[Madhav Krishna S S](https://github.com/ssmadhav)\
    \n [Rajkumar V](https://github.com/Ruggedraj)\
    \n [Rajarajan J](https://github.com/Rajarajan2002)\
    \n [Rajalaksmhi R](https://github.com/RuggedRaji)")
